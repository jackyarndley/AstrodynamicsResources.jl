...
| `:de431_part1` | ephemeris | naif | artifact | yes | `de431_part-1.bsp` |
| `:de431_part2` | ephemeris | naif | artifact | yes | `de431_part-2.bsp` |
...
| `:de441_part1` | ephemeris | naif | artifact | yes | `de441_part-1.bsp` |
| `:de441_part2` | ephemeris | naif | artifact | yes | `de441_part-2.bsp` |
